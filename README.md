...
Email: geoff@pektel.com

LinkedIn: linkedin.com/in/geoffrey-brendel

Phone: (732)-804-8836

💻 Technical Skills

Languages & Frameworks: C++, Python, JavaScript, Flask, React, TensorFlow, PyTorch, SQL

Systems & Tools: Windows, Linux/Unix, MacOS, Docker, Git, AWS Amplify, Jupyter Notebooks

AI & Data Tools: Pandas, NumPy, SciPy, scikit-learn, OpenCV

Web & Databases: MongoDB, RESTful services, Node.js, AWS, Flask

DevOps & Automation: GitLab CI, Jenkins, Docker, Continuous Integration/Continuous Deployment (CI/CD) practices

Development & Debugging: VS, GDB, Valgrind, JIRA, NeoVim

🏗️ Key Projects
🔹 High-Performance Concurrent Banking System

Technologies: C, POSIX Threads, IPC, Synchronization

Designed a high-performance, multi-threaded banking system to handle concurrent transactions.

Eliminated race conditions, optimized locking strategies, and introduced thread-safe data structures, improving throughput by 10x.

🔹 Time Series Data Web Application

Technologies: Flask, Python, HTML/CSS, MongoDB

Developed a modular, full-stack application for managing and serving time-series data.
...
Feel free to check out my repositories, open issues, or drop me a message. I'm always eager to collaborate on innovative projects or share knowledge with fellow developers.
